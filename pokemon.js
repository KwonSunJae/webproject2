...
function changenum1(){
   ...
   $("#char2").css({border:"none"});
   $("#char3").css({border:"none"});
   ch_choose=1;
}
function changenum2(){
   $("#char2").css({border:"3px solid blue","border-radius" :"10px"});
   $("#char1").css({border:"none"});
   $("#char3").css({border:"none"});
    ch_choose=2;
}
function changenum3(){
   $("#char3").css({border:"3px solid green","border-radius" :"10px"});
   $("#char2").css({border:"none"});
   $("#char1").css({border:"none"});
   ch_choose=3;
}
...
function changeBGM(){
    ...
    if (audio_cond) {$("#bg-audio").get(0).play();}
    else{$("#bg-audio").get(0).pause();}
}
